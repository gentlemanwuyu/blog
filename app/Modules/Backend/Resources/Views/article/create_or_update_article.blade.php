...
@section('content')
    ...
    <form class="layui-form" lay-filter="article" style="padding-left: 20px;padding-right: 20px;">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="content" placeholder="" class="layui-textarea">{{empty($article['content']) ? '' : htmlentities($article['content'])}}</textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
...
@section('scripts')
    <script>
        tinymce.init({
            ...
            language:'zh_CN',
            skin: 'oxide',
            plugins: 'lists,advlist image code codesample link paste table',
